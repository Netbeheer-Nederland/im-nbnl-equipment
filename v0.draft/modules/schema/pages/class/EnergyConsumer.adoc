...
EnergyConsumer -> BaseVoltage: BaseVoltage


EnergyConsumer -> Terminal: Terminals


EnergyConsumer -> OperationalLimitSet: OperationalLimitSet


EnergyConsumer -> EquipmentContainer: EquipmentContainer


EnergyConsumer -> PSRType: PSRType
...
//| [[slots_table.customerCount]]<<customerCount,`customerCount`>>
| 0..1 +
