...
EnergyConnection -> BaseVoltage: BaseVoltage


EnergyConnection -> Terminal: Terminals


EnergyConnection -> OperationalLimitSet: OperationalLimitSet


EnergyConnection -> EquipmentContainer: EquipmentContainer


EnergyConnection -> PSRType: PSRType
