...
SeasonDayTypeSchedule -> RegularTimePoint: TimePoints
...
| <<DayType,`DayType`>>
//| [[slots_table.DayType]]<<DayType,`DayType`>>
| 1 +
...
| <<Season,`Season`>>
//| [[slots_table.Season]]<<Season,`Season`>>
| 1 +
...
| xref::class/DayType.adoc[`DayType`] | xref::class/DayType.adoc#SeasonDayTypeSchedules[`SeasonDayTypeSchedules`]



| xref::class/Season.adoc[`Season`] | xref::class/Season.adoc#SeasonDayTypeSchedules[`SeasonDayTypeSchedules`]
