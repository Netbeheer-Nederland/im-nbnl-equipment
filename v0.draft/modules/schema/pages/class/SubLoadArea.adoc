...
| <<LoadArea,`LoadArea`>>
//| [[slots_table.LoadArea]]<<LoadArea,`LoadArea`>>
| 1 +
...
//| [[slots_table.LoadGroups]]<<LoadGroups,`LoadGroups`>>
| 1..* +
...
| xref::class/LoadArea.adoc[`LoadArea`] | xref::class/LoadArea.adoc#SubLoadAreas[`SubLoadAreas`]



| xref::class/LoadGroup.adoc[`LoadGroup`] | xref::class/LoadGroup.adoc#SubLoadArea[`SubLoadArea`]
