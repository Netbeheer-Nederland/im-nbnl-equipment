...
Switch -> BaseVoltage: BaseVoltage


Switch -> Terminal: Terminals


Switch -> OperationalLimitSet: OperationalLimitSet


Switch -> EquipmentContainer: EquipmentContainer


Switch -> PSRType: PSRType
