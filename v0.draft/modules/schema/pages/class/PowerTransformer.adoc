...
intended for use in both balanced and unbalanced representations.
* A power transformer typically has two terminals, but may have one
...
PowerTransformer -> OperationalLimitSet: OperationalLimitSet
