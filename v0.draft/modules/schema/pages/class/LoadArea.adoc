...
//| [[slots_table.SubLoadAreas]]<<SubLoadAreas,`SubLoadAreas`>>
| 1..* +
...
| xref::class/SubLoadArea.adoc[`SubLoadArea`] | xref::class/SubLoadArea.adoc#LoadArea[`LoadArea`]
